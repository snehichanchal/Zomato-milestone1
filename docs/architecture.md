...
sequenceDiagram
    ...
    API Controller->>Restaurant Repository: get_all() / query
    Restaurant Repository-->>Restaurant Filter: restaurants[]
    Restaurant Filter->>Restaurant Filter: filter(restaurants, preferences)
    Restaurant Filter-->>API Controller: candidates[]
    API Controller->>Prompt Builder: build(preferences, candidates)
    ...
    API Controller-->>Presentation Layer: JSON
...
*   [`context.md`](file:///home/testing/Development/Nextleap%20projects/Zomato%20Milestone%201/context.md) — product requirements and workflow
*   [`problem_statement.txt`](file:///home/testing/Development/Nextleap%20projects/Zomato%20Milestone%201/docs/problem_statement.txt) — original problem statement
